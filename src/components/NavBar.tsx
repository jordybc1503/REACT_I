  ...
  return (
    ...
    >
      <div className="w-full flex flex-col justify-between items-center flex-grow 
        md:flex-row
        lg:w-[1024px]">
        <Link to="/" className="w-full md:w-1/3 flex items-center justify-center md:justify-start flex-grow pt-2 md:p-0">
          <img
            className="h-[50px]"
        ...
        <form className="w-full md:w-1/3 flex items-center flex-grow justify-center py-2 md:py-0">
          <input
            className="w-full h-[60px] rounded-[15px] border-none  p-[10px] mx-[20px] md:mx-0 my-2.5 text-sm text-center"
            type="text"
            placeholder="Search"
            id="search"
          />
      ...
      <nav id="navbar" className="w-full px-[15px] py-[20px] bg-[#ff3b3c] flex justify-between list-none flex-wrap
      md:flex-nowrap">
